        ...
        <div class="row">
            <div class="col-sm-7">
                <div class="signin-info">
                    ...
                    <strong>还没有账号？ <a href="/chatroom/register.jsp">立即注册&raquo;</a></strong>
                </div>
            </div>
            <div class="col-sm-5">
                <form id="form1" name="form1" method="post" action="${ pageContext.request.contextPath }/user" onsubmit="return check()">
                    ...
                    <p class="m-t-md">登录到聊天室</p>
                    <input type="text" class="form-control uname" name="username" placeholder="用户名" />
                    <input type="password" class="form-control pword m-b" name="password" placeholder="密码" />
                    <a href="/chatroom/register.jsp">还没有账号？</a>
                    <input  type="submit" class="btn btn-success btn-block" value="登录"></input>
                </form>
            </div>
        </div>
